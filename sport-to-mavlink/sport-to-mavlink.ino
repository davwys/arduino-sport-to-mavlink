...
void setup() {
  ...
  //Serial defaults to 57600 bauds, can be set higher if desired
  Serial.begin(57600);
}
...
/************************************************************
* @brief Decodes the inbound S.Port stream and sets the telemetry variables correspondingly
* @param NONE
* @return void
*************************************************************/
...
void decodeSportData(){
  ...
  // Display data once a second to not interfeere with data decoding TODO check need for this
  currentTime = millis();
